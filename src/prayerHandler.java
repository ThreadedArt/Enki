public class prayerHandler {
	...
	public void noPrayer(int p) {
		client c = (client) server.playerHandler.players[p];
		if (!c.protMage && !c.protRange && !c.protMelee && !c.strLow && !c.strMid && !c.strHigh && !c.defLow
				&& !c.defMid && !c.defHigh && !c.atkLow && !c.atkMid && !c.atkHigh && !c.protItem && !c.rapidRest
				&& !c.rapidHeal && !c.ret && !c.redempt && !c.smite) {
			c.noPrayer = true;
			c.drainPray = false;
		} else {
			c.noPrayer = false;
	...
	public void clickPrayer(int p) {
		...
		case 21233:// Thick Skin
			if (c.getLevelForXP(c.playerXP[5]) >= 1) {
				if (c.playerLevel[5] > 0) {
					...
					c.sendMessage("You have no prayer points!");
					c.frame36(83, 0);
				}
			} else {
				c.sendMessage("You need a prayer level of 1 to use this.");
				c.frame36(83, 0);
			}
			break;
		case 21234:// Burst Of Strength
			if (c.getLevelForXP(c.playerXP[5]) >= 4) {
				...
				c.sendMessage("You need a Prayer level of 4 to use this.");
				c.frame36(84, 0);
			}
			break;
		case 21235:// Clarity Of Thought
			if (c.getLevelForXP(c.playerXP[5]) >= 7) {
				...
				c.sendMessage("You need a Prayer level of 7 to use this.");
				c.frame36(85, 0);
			}
			break;
		case 21236:// Rock Skin
			if (c.getLevelForXP(c.playerXP[5]) >= 10) {
				...
				c.sendMessage("You need a Prayer level of 10 to use this.");
				c.frame36(86, 0);
			}
			break;
		case 21237:// Superhuman Strength
			if (c.getLevelForXP(c.playerXP[5]) >= 13) {
				...
				c.sendMessage("You need a Prayer level of 13 to use this.");
				c.frame36(87, 0);
			}
			break;
		case 21238:// Improved Reflexes
			if (c.getLevelForXP(c.playerXP[5]) >= 16) {
				...
				c.sendMessage("You need a Prayer level of 16 to use this.");
				c.frame36(88, 0);
			}
			break;
		case 21239:// Rapid Restore
			if (c.getLevelForXP(c.playerXP[5]) >= 19) {
				...
				c.sendMessage("You need a Prayer level of 19 to use this.");
				c.frame36(89, 0);
			}
			break;
		case 21240:// Rapid Heal
			if (c.getLevelForXP(c.playerXP[5]) >= 22) {
				...
				c.sendMessage("You need a Prayer level of 22 to use this.");
				c.frame36(90, 0);
			}
			break;
		case 21241:// Protect Item
			if (c.getLevelForXP(c.playerXP[5]) >= 25) {
				...
				c.sendMessage("You need a Prayer level of 25 to use this.");
				c.frame36(91, 0);
			}
			break;
		case 21242:// Steel Skin
			if (c.getLevelForXP(c.playerXP[5]) >= 28) {
				...
				c.sendMessage("You need a Prayer level of 28 to use this.");
				c.frame36(92, 0);
			}
			break;
		case 21243:// Ultimate Strength
			if (c.getLevelForXP(c.playerXP[5]) >= 31) {
				...
				c.sendMessage("You need a Prayer level of 31 to use this.");
				c.frame36(93, 0);
			}
			break;
		case 21244:// Incredible Reflexes
			if (c.getLevelForXP(c.playerXP[5]) >= 34) {
				...
				c.sendMessage("You need a Prayer level of 34 to use this.");
				c.frame36(94, 0);
			}
			break;
		case 21245:// Protect From Magic
			if (c.getLevelForXP(c.playerXP[5]) >= 37) {
				...
				c.sendMessage("You need a Prayer level of 37 to use this.");
				c.frame36(95, 0);
			}
			c.updateRequired = true;
			c.appearanceUpdateRequired = true;
		...
		case 21246:// Protect From Range
			if (c.getLevelForXP(c.playerXP[5]) >= 40) {
				...
				c.sendMessage("You need a Prayer level of 40 to use this.");
				c.frame36(96, 0);
			}
			c.updateRequired = true;
			c.appearanceUpdateRequired = true;
		...
		case 21247:// Protect From Melee
			if (c.getLevelForXP(c.playerXP[5]) >= 43) {
				...
				c.sendMessage("You need a Prayer level of 43 to use this.");
				c.frame36(97, 0);
			}
			c.updateRequired = true;
			c.appearanceUpdateRequired = true;
		...
		case 2171:// Retribution
			if (c.getLevelForXP(c.playerXP[5]) >= 46) {
				...
				c.sendMessage("You need a Prayer level of 46 to use this.");
				c.frame36(98, 0);
			}
			c.updateRequired = true;
			c.appearanceUpdateRequired = true;
		...
		case 2172:// Redemption
			if (c.getLevelForXP(c.playerXP[5]) >= 49) {
				...
				c.sendMessage("You need a Prayer level of 49 to use this.");
				c.frame36(99, 0);
			}
			c.updateRequired = true;
			c.appearanceUpdateRequired = true;
		...
		case 2173:// Smite
			if (c.getLevelForXP(c.playerXP[5]) >= 52) {
				...
				c.sendMessage("You need a Prayer level of 52 to use this.");
				c.frame36(100, 0);
			}
			c.updateRequired = true;
			c.appearanceUpdateRequired = true;
